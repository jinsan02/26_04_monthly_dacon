"""Smart warehouse delay prediction — v5 (Single CatBoost Generalization).

핵심 전략:
1) 단일 모델: CatBoostRegressor
2) 일반화 중심: layout_cluster_id(구조적 그룹) 기반 학습
3) 비율/상호작용 중심 피처 강화
4) 앙상블 제거: submission_v5 단일 출력
"""
